...
<div id="container">
	...
	<div  class="heading">
			<div class="toplinks1" style="width:100%; height:30px; "><a href="#" ><b><center>--TotalVisiting Report--</center></a></b></div>			
	</div>
...
<legend><h3>Total Visitor of day</h3></legend>
<div style= "overflow-y:auto; width:100%;height:300px; background:#FFFFFF">
<table width="88%" bgcolor="white" style="width:900px;" > 
<tr>
...
$q = "select * from visiting_details a, master_visitor b where a.cont_no = b.cont_no and visiting_date='".date('Y-m-d')."' order by visiting_date";
...
<a href="all_print.php" title="Report" style="float:right" class="toplinks" style="float:right"><b><font size="2" color="#333333"><img height="20" width="20" src="../../image/xl.png"/>Get Record</font></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
