...
<form action="../../employee/report/admin_ser_name.php" method="post">
<div id="container">
    <!--top section start-->
	<center>
	<div id="header">
	...
	<div class="heading">
			<div class="toplinks1" style="width:100%; height:30px; "><a href="#" ><center>--Enter Name of visitor--</center></a></div>			
	</div>
        <div id="wrapper">
		<center>
