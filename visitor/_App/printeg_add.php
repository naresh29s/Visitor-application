...
//	$q1 = "select * from preference where cont";
	...
	//$a=$row['need_user_approval'];
	 ...
	 <FONT style="font-size:11px;"><?php echo date('d/m/y H:i');?></FONT></div>
	 </TD>
	 </TR>
	 <TR><TD height="32" colspan="2" valign="top">
	 <FONT style="font-size:11px;">&nbsp;<B>Company: </B></FONT>
	 <FONT style="font-size:11px;">&nbsp;&nbsp;<?php echo $row['vcompname'];?></FONT></TD>
	 </TR>
	 <TR>
	   <TD height="57" class="logo" colspan="2" align="center" ><div style="text-align:center;"><font style="font-family:C39HrP24DhTt; font-size:40px;">*<?php echo $row['Barcode']?>*</font></div>
	 </TD>
	 </TR>
	 <TR>
