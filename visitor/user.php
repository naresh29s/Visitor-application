...
<div id="container">
	...
	<tr valign="top">
	<td width="12%"><a href="#" style="float:left" title="validat_visitor"><h3>Validate Pass</h3></a></td><!--_App/validat_visitor.php -->
	<td width="20%" ><a href="conteractor_pass/vms_cont.php" style="float:left" title="conteractor_pass" ><h3>Contractor Pass</h3></a></td>
	<td width="54%" ><a href="#" title="CreatePass" style="float:right" ><h3>Create New Pass </h3></a></td><!--vms.php-->
	<td width="14%" ><a href="logout.php" title="logout" style="float:right" ><h3><?php echo $_SESSION['UNAME'];?>&nbsp;&nbsp;Logout</h3></a></td>
	</tr>
	</table>
		<br><br><br><br>
