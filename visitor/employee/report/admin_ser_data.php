...
<div id="container">
	...
	<div  class="heading">
			<div class="toplinks1" style="width:100%; height:30px; "><a href="#" ><b><center>--Mobile Number wise Report--</center></a></b></div>			
	</div>
...
<div style= "overflow-y:auto; width:100%;height:200px; background:#FFFFFF">
...
$q = "select * from  visiting_details a, master_visitor b where a.cont_no='$p' and a.cont_no = b.cont_no  ";
...
$row_num = mysql_num_rows($result);
 ...
 echo "<td width='200' align='center'>" ?>  
  ...
  <?php "</td>";
 echo "<td> <a href='edit_numb_serch.php?id=".$row1['Barcode']."'>EDIT</a></td></tr>";
 } 
 echo "<script> alert('Person hace $row_num time visited')</script>"
?>    
</table></div>
</fieldset> 
