...
<div id="container">
	...
	<div class="heading">
			<div class="toplinks1" style="width:100%; height:30px; "><a href="#" ><center>--Edit Status Manually--</center></a></div>			
	</div>
	<center>
...
<td><font color="#990000">Change Status To:</font></td><td><select name="status" style="width:145px">
					...
					</select><INPUT type="hidden" name="barcode" value="<?php echo $row['Barcode']?>" />
					</td>
</tr>
