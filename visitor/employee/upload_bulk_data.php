...
<div id="container">
	...
	<tr valign="top">
	<td width="16%" valign="top"><a href="../employee.php" title="Home"><h3>Home</h3></a></td>
	<td width="84%" align="right"><a href="../logout.php" title="logout" target="_top" ><h3><?php echo $_SESSION['UNAME'];?>&nbsp;&nbsp;Logout</font></h3></a></td>
	</tr>
	</table>
		<br>
<center><b><font size="4px">Format of Excel sheet to upload a bulk data in VMS</font></b></center>
<br>
<table>
<tr><td></td></tr>
<tr><td>1.Create excel file in 1997 and 2000 format(compulsory)<font color="#FF0000">*</font></td></tr>
...
<br>
<table>
<tr><td><img width="800px" src="../visitorimage/bulk_data_formale.PNG" /></td></tr>
</table>
<br>
...
<br><br><br><br>
<table>
<tr><td><b>Attech Excel file and Upload it to vms<b></td></tr>
<tr align="center"><td>
<b>Select file:</b></font><input name="bulk" type="file"/>
</td><td><input type="submit" class="myButton" value="Upload" class="myButton" /></td></tr>
</table>
