...
header('Content-disposition: attachment; filename="Advance_pass.doc"');
?>
<HTML lang="en"><HEAD>
...
<div id="printable">
<TABLE width="460" height="304">
 <TR>
  <TD><DIV style="padding: 10px; text-align:left; margin:10px; width:410px; font-size: 1.0em; top:10%; 1left:10%; border:1px solid #d1d1d1" >
   <TABLE width="412" height="256" style="border-collapse:collapse; border: 0px solid black;">
    <TR>
    ...
    <TR>
	 ...
	 <TD valign="top" width="220"><div style="vertical-align:top; margin-bottom:3px;">
	 <!--img width="95px"  height="63px" src="getImage.php?contno='<?php //echo $row['cont_no']; ?>'"/-->
	 </div>
	 <div style="vertical-align:top; margin-bottom:3px">
	 <FONT style="font-size:11px;"><B>Appointment_Dime:</B></FONT>
