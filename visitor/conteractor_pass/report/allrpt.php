...
//$q = "select * from visiting_details where visiting_date between '".$rpt."' and '".$rpt2."' order by visiting_date";
 //$dep=$_SESSION['dept'];
$q = "SELECT * FROM conteractor_pass_information WHERE start_date='".date('Y-m-d')."' order by start_date";
...
<a href="all_pass.php" title="Report" style="float:right" class="toplinks" style="float:right"><b><font size="2" color="#333333"><img height="20" width="20" src="../../image/xl.png"/>Get Record</font></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
