...
$c=$_SESSION['UNAME'];
$q=$_SESSION[$c];
//$q = "SELECT * FROM conteractor_pass_information WHERE start_date='$date' ORDER BY start_date LIMIT 0 , 30";
$result = mysql_query($q);
$row_num = mysql_num_rows($result);
header("Content-type: application/vnd.ms-excel");
header('Content-disposition: attachment; filename="'.$date.'_pass.xls"');
echo "Pass_ID";echo "\t";
