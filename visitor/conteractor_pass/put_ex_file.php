...
move_uploaded_file($fileTmpLoc, "../employee/bulk_report/$fileName");
// Check to make sure the uploaded file is in place where you want it
if (!file_exists("../employee/bulk_report/$fileName")) {
...
?>
<?php 
echo "<script>window.location.href='../employee/bulk_report/b_report.php?name=$fileName&type=cont_data';
</script>";
